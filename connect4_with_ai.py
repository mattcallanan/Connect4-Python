...
player1 = Player(human_agent, PLAYER1_ID, "Human", "Yellow", YELLOW)
...
# player1 = Player(human_agent, PLAYER1_ID, "Human 1", "Yellow", YELLOW)
# player2 = Player(human_agent, PLAYER2_ID, "Human 2", "Red", RED)
